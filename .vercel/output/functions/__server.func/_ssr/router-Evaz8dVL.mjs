...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Evaz8dVL.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CjdAuoi2.css";
...
var $$splitComponentImporter = () => import("./routes-BA5ETqig.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Champions Casino — Internal Revenue Leaderboard" },
		{
			name: "description",
			content: "A premium casino-style leaderboard celebrating the employees who hit the biggest revenue jackpots."
		},
		{
			property: "og:title",
			content: "Champions Casino — Internal Revenue Leaderboard"
		},
		{
			property: "og:description",
